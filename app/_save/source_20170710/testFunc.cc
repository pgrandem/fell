...
void listParticles()
{
  ...
  RDump::line(60, "-");
  mol = RParticleList::mAr();   mol->dumpLine(); delete mol;
  mol = RParticleList::mCH4();  mol->dumpLine(); delete mol;
  mol = RParticleList::mCO();   mol->dumpLine(); delete mol;
  mol = RParticleList::mCO2();  mol->dumpLine(); delete mol;
  mol = RParticleList::mH2();   mol->dumpLine(); delete mol;
  mol = RParticleList::mKr();   mol->dumpLine(); delete mol;
  mol = RParticleList::mN2();   mol->dumpLine(); delete mol;
  mol = RParticleList::mNe();   mol->dumpLine(); delete mol;
  mol = RParticleList::mXe();   mol->dumpLine(); delete mol;
